...
get_terminal_help_usage() {
    ...
    th_note "its own block, and touches neither of your two directories — and"
    th_note "keeps the topics you already selected"
    th_row "Change topics:" "th_topics enable <topic>    (no clone needed)"
    th_row "Choose again:"  "./install.sh --reset        (the menu, in the clone)"
